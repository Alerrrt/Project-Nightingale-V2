...
- Clarify Next.js + TailwindÂ CSS v3 integration requirements (#46176) @chaitanyasharma1011
...
- Upgrade MUIÂ X packages to v8 (#45990) @KenanYusuf
...
A big thanks to the 21 contributors who made this release possible. Here are some highlights âœ¨:

- ðŸŽ‰ MaterialÂ UI now works with **TailwindÂ CSS v4**! Check out the [setup guide](https://mui.com/material-ui/integrations/tailwindcss/tailwindcss-v4/).
...
- Update CSS variable usage in migration guide for PigmentÂ CSS (#46033) @sai6855
- Fix docs API dark mode color (#46086) @alexfauquette
- Add a guide for extending MaterialÂ UI classes in TailwindÂ CSS (#46039) @siriwatknp
- Add `InitColorSchemeScript` docs and API (#45927) @siriwatknp
- Add TailwindÂ CSS v4 integration guide (#45906) @siriwatknp
- Fix 301 links to the system v6 (#45931) @oliviertassinari
- Add notification for MUIÂ X v8 announcement (#45942) @joserodolfofreitas
...
- Add "MaterialÂ UIÂ v7 is here" to the notifications (#45694) @DiegoAndai
...
ðŸŽ‰ We're happy to announce the stable release of v7.
...
This release contains bug fixes ðŸ› and improvements to the new package layout ðŸ—ï¸.
...
- [docs-infra] Add @ts-ignore to avoid type checking for MUIÂ X (#45555) @siriwatknp
...
- [blog] React 19 migration for MUIÂ X (#45348) @arminmeh
...
- Add `overriding-component-structure` doc to MaterialÂ UI (#45186) @siriwatknp
...
- [docs-infra] Revert to use deprecated `CssVarsProvider` for MUIÂ X (#45371) @siriwatknp
- [docs-infra] Fix dark mode flicker for API pages (#45354) @siriwatknp
- [examples] Remove unnecessary comma in MaterialÂ UI Vite JS example (#45370) @ZeeshanTamboli
