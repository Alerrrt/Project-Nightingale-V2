...
export interface DefaultArcObject {
    ...
    outerRadius: number;
    /**
     * Start angle of arc. The angle is specified in radians, with 0 at -y (12 oâ€™clock) and positive angles proceeding clockwise.
     */
    startAngle: number;
    /**
     * End angle of arc. The angle is specified in radians, with 0 at -y (12 oâ€™clock) and positive angles proceeding clockwise.
     */
    endAngle: number;
    /**
 ...
 * If it is less than Ï„, arcs may have rounded corners and angular padding. Arcs are always centered at âŸ¨0,0âŸ©; use a transform (see: SVG, Canvas) to move the arc to a different position.
 *
...
export interface Arc<This, Datum> {
     ...
     * In addition, for arcs whose angular span is less than Ï€, the corner radius may be reduced as two adjacent rounded corners intersect.
     ...
     *
     * The angle is specified in radians, with 0 at -y (12 oâ€™clock) and positive angles proceeding clockwise.
     * If |endAngle - startAngle| â‰¥ Ï„, a complete circle or annulus is generated rather than a sector.
     *
     ...
     * If the arc forms a complete circle or annulus, as when |endAngle - startAngle| â‰¥ Ï„, the pad angle is ignored. If the inner radius or angular span is small relative to the pad angle,
     ...
     *
     * The recommended minimum inner radius when using padding is outerRadius * padAngle / sin(Î¸), where Î¸ is the angular span of the smallest arc before padding.
     * For example, if the outer radius is 200 pixels and the pad angle is 0.02 radians, a reasonable Î¸ is 0.04 radians, and a reasonable inner radius is 100 pixels.
     *
...
export interface PieArcDatum<T> {
     ...
     * then the units are in radians with 0 at -y (12 oâ€™clock) and positive angles proceeding clockwise.
     */
    startAngle: number;
    /**
...
export interface Pie<This, Datum> {
     ...
     * Any additional arguments are arbitrary; they are simply propagated to the pie generatorâ€™s accessor functions along with the this object.
     ...
     *
     * This representation is designed to work with the arc generatorâ€™s default startAngle, endAngle and padAngle accessors.
     * The angular units are arbitrary, but if you plan to use the pie generator in conjunction with an arc generator,
     * you should specify angles in radians, with 0 at -y (12 oâ€™clock) and positive angles proceeding clockwise.
     *
     ...
     * you should specify an angle in radians, with 0 at -y (12 oâ€™clock) and positive angles proceeding clockwise.
     *
     ...
     * you should specify an angle in radians, with 0 at -y (12 oâ€™clock) and positive angles proceeding clockwise.
     *
     * The value of the end angle is constrained to startAngle Â± Ï„, such that |endAngle - startAngle| â‰¤ Ï„.
     *
     * @param angle A constant angle.
     */
    endAngle(angle: number): this;
 ...
 * Radial lines are always positioned relative to âŸ¨0,0âŸ©; use a transform (see: SVG, Canvas) to change the origin.
 *
 * The generic refers to the data type of an element in the input array passed into the line generator.
 */
export interface LineRadial<Datum> {
    /**
     * Generates a radial line for the given array of data. Depending on this radial line generatorâ€™s associated curve,
     * the given input data may need to be sorted by x-value before being passed to the line generator.
     *
     ...
     *
     * @param angle A constant angle value in radians, with 0 at -y (12 oâ€™clock).
     */
     ...
     * then you should specify a custom accessor.
     *
     * @param angle An angle accessor function which returns the angle value in radians, with 0 at -y (12 oâ€™clock). The angle accessor will be invoked for each defined element in the input data array,
     * being passed the element d, the index i, and the array data as three arguments.
     */
...
export interface Area<Datum> {
    /**
     * Generates an area for the given array of data. Depending on this area generatorâ€™s associated curve,
    ...
    /**
     * Returns a new line generator that has this area generatorâ€™s current defined accessor, curve and context.
     * The lineâ€™s x-accessor is this areaâ€™s x0-accessor, and the lineâ€™s y-accessor is this areaâ€™s y0-accessor.
     */
    lineX0(): Line<Datum>;
    /**
     * Returns a new line generator that has this area generatorâ€™s current defined accessor, curve and context.
    ...
    /**
     * Returns a new line generator that has this area generatorâ€™s current defined accessor, curve and context.
     * The lineâ€™s x-accessor is this areaâ€™s x1-accessor, and the lineâ€™s y-accessor is this areaâ€™s y0-accessor.
     */
    lineX1(): Line<Datum>;
    /**
     * Returns a new line generator that has this area generatorâ€™s current defined accessor, curve and context.
     * The lineâ€™s x-accessor is this areaâ€™s x0-accessor, and the lineâ€™s y-accessor is this areaâ€™s y1-accessor.
     */
    lineY1(): Line<Datum>;
}
 ...
 * except the x and y accessors are replaced with angle and radius accessors.
 * Radial areas are always positioned relative to âŸ¨0,0âŸ©; use a transform (see: SVG, Canvas) to change the origin.
 *
 * The generic refers to the data type of an element in the input array passed into the area generator.
 */
export interface AreaRadial<Datum> {
     ...
     *
     * @param angle A constant value in radians with 0 at -y (12 oâ€™clock).
     */
    angle(angle: number): this;
    /**
     ...
     * If your data are in a different format, or if you wish to transform the data before rendering, then you should specify a custom accessor.
     *
     * @param angle An accessor function returning a value to be used for startAngle in radians with 0 at -y (12 oâ€™clock).
    ...
    /**
     * Equivalent to area.x1, except the accessor returns the angle in radians, with 0 at -y (12 oâ€™clock).
     ...
     * If your data are in a different format, or if you wish to transform the data before rendering, then you should specify a custom accessor.
     *
     * @param angle An accessor function returning a value to be used for endAngle in radians with 0 at -y (12 oâ€™clock).
     * The accessor will be invoked for each defined element in the input data array,
     * being passed the element d, the index i, and the array data as three arguments.
     */
    ...
    /**
     * Equivalent to area.y1, except the accessor returns the radius: the distance from the origin âŸ¨0,0âŸ©.
     */
    ...
    /**
     * Returns a new radial line generator that has this radial area generatorâ€™s current defined accessor, curve and context.
     * The lineâ€™s angle accessor is this areaâ€™s start angle accessor, and the lineâ€™s radius accessor is this areaâ€™s inner radius accessor.
     */
    ...
    /**
     * Returns a new radial line generator that has this radial area generatorâ€™s current defined accessor, curve and context.
     * The lineâ€™s angle accessor is this areaâ€™s end angle accessor, and the lineâ€™s radius accessor is this areaâ€™s inner radius accessor.
     */
    lineEndAngle(): LineRadial<Datum>;

    /**
     * Returns a new radial line generator that has this radial area generatorâ€™s current defined accessor, curve and context.
     * The lineâ€™s angle accessor is this areaâ€™s start angle accessor, and the lineâ€™s radius accessor is this areaâ€™s outer radius accessor.
     */
 ...
 * with the spline straightened according to the curveâ€™s beta, which defaults to 0.85.
 ...
 * A curve factory for cubic Catmullâ€“Rom spline generators.
 *
 * The curve generators produce a cubic Catmullâ€“Rom spline using the specified control points and the parameter alpha,
 * which defaults to 0.5, as proposed by Yuksel et al. in On the Parameterization of Catmullâ€“Rom Curves,
 ...
 * A curve factory for cubic Catmullâ€“Rom spline generators.
 *
 * The curve generators produce a closed cubic Catmullâ€“Rom spline using the specified control points and the parameter alpha,
 ...
 * â€œa smooth curve with continuous first-order derivatives that passes through any given set of data points without spurious oscillations.
 * Local extrema can occur only at grid points where they are given by the data, but not in between two adjacent grid points.â€
 */
...
export interface DefaultLinkObject {
     ...
     * the coordinates [angle, radius]. The angle is stated in radians, with 0 at -y (12 oâ€™clock).
     * The radius measures the distance from the origin âŸ¨0,0âŸ©.
     */
...
/**
 * A link generator for a Cartesian coordinate system. The link shape generates a smooth cubic BÃ©zier curve from a
...
export interface LinkRadial<This, LinkDatum, NodeDatum> {
     ...
     * The angle is stated in radians, with 0 at -y (12 oâ€™clock).
     *
     ...
     * The radius is measured as the distance from the origin âŸ¨0,0âŸ©.
     *
 ...
 * A symbol generator.
 *
 * Symbols provide a categorical shape encoding as is commonly used in scatterplots. Symbols are always centered at âŸ¨0,0âŸ©;
 ...
 * @param angle Angle in radians, with 0 at -y (12 oâ€™clock) and positive angles proceeding clockwise.
 * @param radius Radius.
 */
...
export interface Stack<This, Datum, Key> {
     ...
     *
     * Any additional arguments are arbitrary; they are simply propagated to the generatorâ€™s accessor functions along with the this object.
     *
     * @param data Array of data elements.
     */
     ...
     * The seriesâ€™ key is passed to the value accessor, along with each data point, to compute the pointâ€™s value.
     */
...
/**
 * Returns the given series order [0, 1, â€¦ n - 1] where n is the number of elements in series. Thus, the stack order is given by the key accessor.
 *
 * @param series A series generated by a stack generator.
 */
...
/**
 * Returns the reverse of the given series order [n - 1, n - 2, â€¦ 0] where n is the number of elements in series. Thus, the stack order is given by the reverse of the key accessor.
 *
 * @param series A series generated by a stack generator.
 */
