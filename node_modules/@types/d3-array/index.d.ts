...
/**
 * Returns an unbiased estimator of the population variance of the given iterable of numbers using Welfordâ€™s algorithm.
...
export class Adder {
    ...
    /**
     * Returns the IEEE 754 double precision representation of the adderâ€™s current value.
...
/**
 * Equivalent to group, but returns a flat array of [key0, key1, â€¦, values] instead of nested maps.
 *
 * @param iterable The iterable to group.
 * @param keys The key functions.
 */
 ...
 * nicely-rounded values consistent with the inferred step. More formally, each returned tick t satisfies start â‰¤ t and t â‰¤ stop.
 *
