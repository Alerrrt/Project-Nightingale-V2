...
export interface ScaleContinuousNumeric<Range, Output, Unknown = never> {
    ...
    /**
     * Returns a copy of the scaleâ€™s current domain.
     */
    domain(): number[];
    /**
     * Sets the scaleâ€™s domain to the specified array of numbers. The array must contain two or more elements.
    ...
    /**
     * Returns a copy of the scaleâ€™s current range.
     */
    range(): Range[];
    /**
     * Sets the scaleâ€™s range to the specified array of values.
     *
    ...
    /**
     * Sets the scaleâ€™s range to the specified array of values while also setting the scaleâ€™s interpolator to interpolateRound.
     *
     * The rounding interpolator is sometimes useful for avoiding antialiasing artifacts,
     * though also consider the shape-rendering â€œcrispEdgesâ€ styles. Note that this interpolator can only be used with numeric ranges.
     *
     * The array must contain two or more elements. Unlike the domain, elements in the given array need not be numbers;
     * any value that is supported by the underlying interpolator will work, though note that numeric ranges are required for invert.
     *
     ...
     *
     * If clamping is enabled, the return value of the scale is always within the scaleâ€™s range. Clamping similarly applies to the "invert" method.
     *
    ...
    /**
     * Returns approximately count representative values from the scaleâ€™s domain.
     *
     ...
     * The specified count is only a hint; the scale may return more or fewer values depending on the domain. See also d3-arrayâ€™s ticks.
     *
     ...
     * For example, for a domain of [0.201479â€¦, 0.996679â€¦], a nice domain might be [0.2, 1.0].
...
export interface ScaleLinear<Range, Output, Unknown = never> extends ScaleContinuousNumeric<Range, Output, Unknown> {
    /**
     * Returns the scaleâ€™s current interpolator factory, which defaults to interpolate.
     */
    interpolate(): InterpolatorFactory<any, any>;

    /**
     * Sets the scaleâ€™s range interpolator factory. This interpolator factory is used to create interpolators for each adjacent pair of values from the range;
     ...
     * however, if you need to store the scaleâ€™s return value, you must specify your own interpolator or make a copy as appropriate.
     *
 ...
 *
 * As log(0) = -âˆž, a log scale domain must be strictly-positive or strictly-negative; the domain must not include or cross zero.
    ...
    extends ScaleContinuousNumeric<Range, Output, Unknown>
{
    ...
    /**
     * Extends the domain to integer powers of base. For example, for a domain of [0.201479â€¦, 0.996679â€¦], and base 10, the nice domain is [0.1, 1].
     * If the domain has more than two values, nicing the domain only affects the first and last value.
     *
     * Nicing a scale only modifies the current domain; it does not automatically nice domains that are subsequently set using continuous.domain.
     * You must re-nice the scale after setting the new domain, if desired.
 ...
 * Continuous scales map a continuous, quantitative input domain to a continuous output range.
 *
 * See â€œA bi-symmetric log transformation for wide-range dataâ€ by Webber for more
 *
 * If the range is also numeric, the mapping may be inverted.
 *
 * Note that the data types of the range and output of the scale must be compatible with the interpolator applied by the scale.
...
export interface ScaleSymLog<Range, Output, Unknown = never> extends ScaleContinuousNumeric<Range, Output, Unknown> {
     ...
     * otherwise returns the current value of the symlog constant, which defaults to 1. See â€œA bi-symmetric log transformation for wide-range dataâ€ by Webber for more.
     */
...
export interface ScaleTime<Range, Output, Unknown = never> {
    ...
    /**
     * Sets the scaleâ€™s domain to the specified array of temporal domain values. The array must contain two or more elements.
    ...
    /**
     * Returns representative dates from the scaleâ€™s domain. The returned tick values are uniformly-spaced (mostly),
...
export interface ScaleSequentialBase<Output, Unknown = never> {
    ...
    /**
     * Sets the scaleâ€™s domain to the specified array of numbers. The array must contain exactly two elements.
     * If the elements in the given array are not numbers, they will be coerced to numbers
     *
 ...
 *
 * If interpolator is an array, it represents the scaleâ€™s two-element output range and is converted to an interpolator function using d3.interpolate.
 *
 * The first generic corresponds to the data type of the output of the interpolator underlying the scale.
 * The second generic corresponds to the data type of the unknown value.
 *
...
export interface ScaleDiverging<Output, Unknown = never> {
    ...
    /**
     * Sets the scaleâ€™s domain to the specified array of numbers.
     ...
     * the scale may return a value outside the range through extrapolation.
     *
     * If clamping is enabled, the return value of the scale is always within the interpolator scaleâ€™s range.
     *
     * @param clamp A flag to enable (true) or disable (false) clamping.
     */
    clamp(clamp: boolean): this;
    ...
    /**
     * Returns the scaleâ€™s current interpolator.
     */
    interpolator(): (t: number) => Output;
    /**
     * Sets the scaleâ€™s interpolator to the specified function.
     *
     * @param interpolator The scaleâ€™s interpolator.
     */
    interpolator(interpolator?: (t: number) => Output): this;
 ...
 *
 * If interpolator is an array, it represents the scaleâ€™s three-element output range and is converted to an interpolator function using d3.interpolate and d3.piecewise.
 *
 * The first generic corresponds to the data type of the interpolator return type.
 * The second generic corresponds to the data type of the unknown value.
 *
 * @param interpolator The scaleâ€™s interpolator function or array.
 */
// eslint-disable-next-line @definitelytyped/no-unnecessary-generics
...
export interface ScaleQuantize<Range, Unknown = never> {
    ...
    /**
     * Sets the scaleâ€™s domain to the specified two-element array of numbers.
     * If the elements in the given array are not numbers, they will be coerced to numbers.
     *
    ...
    range(): Range[];
    /**
     * Sets the scaleâ€™s range to the specified array of values. The array may contain any number of discrete values.
     *
     * @param range Array of range values.
     */
    range(range: Iterable<Range>): this;
 ...
 * To compute the quantiles, the domain is sorted, and treated as a population of discrete values; see d3-arrayâ€™s quantile.
 *
 ...
 *
 * If the number of values in the scaleâ€™s range is N+1, the number of values in the scaleâ€™s domain must be N.
...
export interface ScaleThreshold<Domain extends number | string | Date, Range, Unknown = never> {
    ...
    domain(): Domain[];
    /**
     * Sets the scaleâ€™s domain to the specified array of values. The values must be in sorted ascending order, or the behavior of the scale is undefined.
    ...
    range(): Range[];
    /**
     * Sets the scaleâ€™s range to the specified array of values. If the number of values in the scaleâ€™s domain is N, the number of values in the scaleâ€™s range must be N+1.
...
export interface ScaleOrdinal<Domain extends { toString(): string }, Range, Unknown = never> {
     ...
     * Thus, an ordinal scaleâ€™s values must be coercible to a primitive value, and the primitive domain value uniquely identifies the corresponding range value.
     *
...
export interface ScaleBand<Domain extends { toString(): string }> {
     ...
     * If the given value is not in the scaleâ€™s domain, returns undefined.
     *
     * @param x  A value from the domain.
     */
     ...
     * Thus, a band scaleâ€™s values must be coercible to a primitive value, and the primitive domain value uniquely identifies the corresponding band.
     *
     * @param domain Array of domain values.
     */
    domain(domain: Iterable<Domain>): this;
    ...
    /**
     * Returns the scaleâ€™s current range, which defaults to [0, 1].
     */
    range(): [number, number];
    /**
     * Sets the scaleâ€™s range to the specified two-element array of numbers. If the elements in the given array are not numbers, they will be coerced to numbers.
    ...
    /**
     * Sets the scaleâ€™s range to the specified two-element array of numbers while also enabling rounding.
     * If the elements in the given array are not numbers, they will be coerced to numbers.
     *
     * Rounding is sometimes useful for avoiding antialiasing artifacts, though also consider the shape-rendering â€œcrispEdgesâ€ styles.
     *
     * @param range A two-element array of numeric values.
     */
    rangeRound(range: Iterable<NumberValue>): this;
...
export interface ScalePoint<Domain extends { toString(): string }> {
     ...
     * Thus, a point scaleâ€™s values must be coercible to a primitive value, and the primitive domain value uniquely identifies the corresponding point.
     *
     * @param domain Array of domain values.
     */
    domain(domain: Iterable<Domain>): this;
    ...
    range(): [number, number];
    /**
     * Sets the scaleâ€™s range to the specified two-element array of numbers.
     * If the elements in the given array are not numbers, they will be coerced to numbers.
     * The default range is [0, 1].
     *
     * @param range A two-element array of numeric values.
